...
public class PChangePassClass {
    Context pcon;
    ProgressDialog dialog;
    public PChangePassClass(ChangePass changePass, final String oldpas, final String newpas, final String email) {

        this.pcon=changePass;
        String urllogin="http://avidsoft.ir/php/pchangepass.php";
