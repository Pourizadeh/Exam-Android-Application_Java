...
public class GetTestInfoClass {
    Context context;
     String url;
    ProgressDialog dialog;
    public GetTestInfoClass(Context context) {
        ...
        url="http://avidsoft.ir/php/gettestinfo.php/?email="+appPreferencesHelper.getCurrentEmail();
    }
